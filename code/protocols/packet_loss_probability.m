...
semilogy(active_users_distr, packet_loss_probabilities(1,:)...
...
legend('Вероятность доступа = 0.1'...
      ,'Вероятность доступа = 0.3'...
      ,'Вероятность доступа = 0.5'...
      ,'Вероятность доступа = 0.6'...
      ,'Вероятность доступа = 0.9'...
      );
 
xlabel('Число активных пользователей');
