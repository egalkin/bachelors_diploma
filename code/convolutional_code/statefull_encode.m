...
% Почти то же самое, что encode, но используется  для поблочного
% кодирования в ситуации, когда мы получаем не все блоки сразу, а получаем
% их постепенно, как при передаче пакетов.
